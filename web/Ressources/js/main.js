...
BRUSHED.contactForm = function(){
	$("#contact-submit").on('click',function() {
		...
		$.ajax({
			type: "POST",
			url: "{{ app.request.basepath }}/Ressources/php/contact.php",
			data: fields,
			dataType: 'json',
...
BRUSHED.tweetFeed = function(){
    ...
    $("#ticker").tweet({
          modpath: '{{ app.request.basepath }}/Ressources/js/twitter/',
          username: "YruamaCrystal", // Change this with YOUR ID
          page: 1,
          avatar_size: 0,
          count: 10,
		  template: "{text}{time}",
...
$(document).ready(function(){
	Modernizr.load([
	{
		...
		nope: '{{ app.request.basepath }}/Ressources/js/placeholder.js', 
		complete : function() {
